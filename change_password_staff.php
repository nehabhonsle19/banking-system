...
<div class="change_password_admin">
    <div id="login-overlay" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="staffChangePasswor">Change Password</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="well">
                            <form id="staffChangePassword" method="post" novalidate="novalidate">
    ...
    if (isset($_REQUEST['change_password'])){
        ...
        if ($rws[9]==$old && $new==$again){
            $sql1="UPDATE admin SET pwd='$new' WHERE email='$user'";
